  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Get Started in Minutes</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Link your WooCommerce store and sync your product catalog automatically</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Customize your chatbot's personality, branding, and responses</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Add the widget to your site and track performance with detailed analytics</p>
            </div>
          </div>
        </div>
      </section>
